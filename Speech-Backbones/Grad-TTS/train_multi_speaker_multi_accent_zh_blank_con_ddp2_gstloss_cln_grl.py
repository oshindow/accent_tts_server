...
import params
from model import GradTTSGST, GradTTSConformer, GradTTSConformerGST, GradTTSConformerGSTGRL
...
log_dir = '/data2/xintong/gradtts/logs/new_exp_sg_acc_blank_conformer_gst_E11'
...
def run(rank, n_gpus):
    ...
    model = GradTTSConformerGSTGRL(nsymbols, n_spks, spk_emb_dim, n_enc_channels,
