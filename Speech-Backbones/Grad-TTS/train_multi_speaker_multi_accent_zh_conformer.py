...
log_dir = '/data2/xintong/gradtts/logs/new_exp_sg_acc_conformer'
...
nsymbols = ZHDict(zhdict_path).__len__() + 1 if add_blank else ZHDict(zhdict_path).__len__()
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        with torch.no_grad():
            for item in test_batch:
                ...
                i = int(spk.cpu())
                # print(x.shape, x_lengths, y.shape, y_lengths)
