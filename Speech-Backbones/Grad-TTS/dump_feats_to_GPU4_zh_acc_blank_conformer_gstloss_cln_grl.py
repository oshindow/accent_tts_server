...
import os
import params
from model import GradTTSConformer, GradTTSGST, GradTTSConformerGSTGRL
...
if __name__ == '__main__':
    ...
    generator = GradTTSConformerGSTGRL(zh_dict.__len__() + 1, params.n_spks, params.spk_emb_dim,
            ...
            if acc_ids[i] == 3:
                if spk_ids[i] > 217 and utt_ids[i][:3] != 'SSB':
                    ...
                    if not os.path.isfile(filepath):
                        ...
                        # filepath = '/data2/xintong/aishell3/test/wav_16k/SSB0632/SSB06320250.wav'
            ...
            if acc_ids[i] < 3:
                if spk_ids[i] < 217:
                    ...
                    if not os.path.isfile(filepath):
                        ...
                        filepath = '/data2/xintong/aishell3/test/wav_16k/SSB0632/SSB06320250.wav'
                        # filepath = '/home/xintong/Speech-Backbones/Grad-TTS/tianjin/zuilaoshi_trim10s.wav'
                else:
                    # filepath = '/data2/xintong/aishell3/test/wav_16k/SSB0590/SSB05900401.wav'
                    filepath = '/data2/xintong/aishell3/test/wav_16k/SSB0632/SSB06320250.wav'
                    # filepath = '/home/xintong/Speech-Backbones/Grad-TTS/tianjin/zuilaoshi_trim10s.wav'
