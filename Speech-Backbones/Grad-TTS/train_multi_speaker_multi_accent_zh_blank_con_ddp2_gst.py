...
import params
from model import GradTTSGST, GradTTSConformer
...
log_dir = '/data2/xintong/gradtts/logs/new_exp_sg_acc_blank_conformer_gst_E5'
...
pretrained_model = 'logs/new_exp_sg_acc_blank_conformer_gst_E5/grad_77.pt'
