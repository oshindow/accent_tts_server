...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', '--reference', type=str, required=False, default='resources/filelists/synthesis_zh.txt', help='path to a file with texts to synthesize')
